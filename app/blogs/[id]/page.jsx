		...
		<>
			<div className="bg-gray-200 py-5 px-5 md:px-12 lg:px-28">
				<div className="flex justify-between items-center">
					<Link href={"/"}>
						<Image src={assets.logo} width={180} alt="" className="w-[150px]" />
					</Link>
			...
			<div className="mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10">
				...
				<p className="my-3">
					...
					corrupti accusamus, in, perferendis, iure autem nulla optio iusto
					impedit quibusdam molestias eum atque dolores ad exercitationem quod.
					Nemo, libero est?
				</p>
				<p className="my-3">
					Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusantium
				...
				<div className="my-24">
					...
					<div className="flex">
						...
						<Image src={assets.googleplus_icon} alt="googe_pluse" width={50} />
					</div>
				</div>
			</div>
			<Footer />
